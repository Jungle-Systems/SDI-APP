...
export default function ClaimVerificationPage({ params }: { params: Promise<{ companyId: string }> }) {
  ...
  if (!report) return (
    <div className="px-10 py-10">
      ...
      <p className="text-[#9CA3AF] text-sm">No verification report available for this company yet.</p>
    </div>
  )
  ...
  return (
    <div className="px-10 py-10 max-w-5xl">
      ...
      <div className="mb-8">
        ...
        <div className="text-[10px] font-mono text-[#9CA3AF] uppercase tracking-widest mb-3">Claim Verification Report</div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        <div className="card col-span-1">
          ...
          <div className="text-[10px] text-[#9CA3AF] leading-relaxed">
            {report.collision_flag_count} risk flags identified across CSRD/IFRS filing
          </div>
        </div>

        <div className="card col-span-2">
          <div className="text-[11px] font-semibold text-[#374151] mb-1">EBITDA Impact Scenarios</div>
          <p className="text-[11px] text-[#9CA3AF] mb-4">Estimated margin impact if identified risks materialise — base, tightening, and worst-case.</p>
      ...
      {flags.length > 0 && (
        <div className="card mb-8">
          <div className="text-[11px] font-semibold text-[#374151] mb-1">Risk Flags</div>
          <p className="text-[11px] text-[#9CA3AF] mb-5">Claims in the disclosure that diverge from external evidence.</p>
      ...
      {/* SFDR Narrative */}
      <div className="card">
        <div className="text-[11px] font-semibold text-[#374151] mb-1">SFDR Investor Narrative</div>
        <p className="text-[11px] text-[#9CA3AF] mb-4">Plain-language summary of material risks for inclusion in SFDR reporting.</p>
